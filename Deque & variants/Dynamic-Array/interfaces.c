...
void initDeque(struct Deque* dq, int cap)
{
   ...
   *    The function allocates memory for a dynamic array with 'cap' starting capacity.
   *    
   *  Parameters:
   *    [struct] (Deque*) dq: A pointer to the Deque.
   *    [int]            cap: The starting capacity of the Deque.
   * 
   *  Pre-conditions:
   ...
   * 
   *  Post-conditions:
   *    - The Deque is initialized: the capacity is set, the size is 0, and a dynamic array is allocated.
   */
  ...
  dq->capacity = cap;
  dq->size = 0;
  dq->data = (TYPE*) malloc(sizeof(dq->capacity * sizeof(TYPE)));
...
{
  /*  Description:
   *    Function frees the dynamic array associated with the Deque.
   *    
   *  Parameters:
   *    [struct] (Deque*) dq: A pointer to the Deque.
   * 
...
{
  /*  Description:
   *    Function adds the [TYPE] val to the front of the Deque.
   *    Also checks capacity and doubles if needed.
   *    
   *  Parameters:
   *    [struct]  (Deque*)  dq  : A pointer to the Deque.
   ...
   * 
   *  Post-conditions:
   *    - The value is added to the proper floating front of the Deque
   *    - If Deque was at capacity, capacity is doubled.
   */
